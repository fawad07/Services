...
def upload():
    ...
    output_path = os.path.join(
        output_folder, f"{os.path.splitext(filename)[0]}_background_removed.png"
    )
    # Check if the image was loaded successfully
...
def convert():
    ...
    if is_youtube_url(youtube_url):
        ...
        return redirect(
            url_for("home")
        )  # "Download Started. Check console for progress"
    else:
    ...
    #return "Under construction"		#redirect(url_for("home"))
